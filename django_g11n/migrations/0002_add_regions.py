# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-10-10 09:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dts_update', models.DateTimeField(blank=True, null=True)),
                ('dts_delete', models.DateTimeField(blank=True, null=True)),
                ('lower', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lower', to='django_g11n.Region')),
                ('upper', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='upper', to='django_g11n.Region')),
            ],
        ),
